...
async function createPlanFromAction(accion: string, indicadorBase: string) {
  ...
  async function saveCurrent(overrides?: Partial<UnifiedForm>) {
    ...
    if (!base.id && firstChild && firstChild.id && looksEmpty) {
      ...
      const withActor = { ...updated, updated_by_email: actorEmail,  entidad: base.entidad ?? base.nombre_entidad ?? null };
      ...
      const withActor = { ...created, updated_by_email: actorEmail, entidad: base.entidad ?? base.nombre_entidad ?? null, };
